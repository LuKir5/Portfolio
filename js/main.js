...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const projects = document.querySelectorAll('.project-one, .project-two, .project-three');
...
function changeContactIcons() {
  ...
  setInterval(() => { // Bild ausblenden
    imgElement.style.opacity = 0;
    
    setTimeout(() => { // Nächstes Bild setzen
...
// ----------------------------------------- //
document.addEventListener('DOMContentLoaded', () => { // Alle Links mit einem `href`-Attribut, das mit `#` beginnt, auswählen
